...
if [[ $EVAL_IN_PLACE == "--eval_in_place" ]]; then
    ...
    eval_in_place_options+="--eval_output_dir output/$SUBFOLDER/kitti_eigen_test/${IDENTIFIER}_${SUBFOLDER}_metric "
fi
...
python infer.py \
    ...
    --output_dir "$OUTPUT_DIR/$SUBFOLDER/kitti_eigen_test/prediction_$IDENTIFIER" \
