...
python eval.py \
    ...
    --prediction_dir "$OUTPUT_DIR/$SUBFOLDER/kitti_eigen_test/prediction_$IDENTIFIER" \
    --output_dir "output/$SUBFOLDER/kitti_eigen_test/${IDENTIFIER}_${SUBFOLDER}_metric"
